...
void USART_IRQInterruptConfig(uint8_t IRQNumber, uint8_t En_or_Di)
{
...
void USART_IRQHandling(USART_Handle_t *pUSARTHandle)
{
	...
	if(temp1 && temp2)
	{
		...
		else if(pUSARTHandle->RxBusyState == USART_BUSY_IN_RX)
		{
			...
			if(!pUSARTHandle->RxLen)
			{
				...
				//Call the application call back with event USART_EVENT_RX_CMPLT
